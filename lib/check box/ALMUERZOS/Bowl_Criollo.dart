...
class CheckboxBowl extends StatefulWidget {
  CheckboxBowl({Key? key}) : super(key: key);

  @override
  _CheckboxBowlState createState() => _CheckboxBowlState();
}

class _CheckboxBowlState extends State<CheckboxBowl> {
  List<CheckboxAlmuerzo> _dropdownAvailability = <CheckboxAlmuerzo>[];
  @override
  String comentarios = "";
  void initState(){
    _dropdownAvailability.addAll({
      CheckboxAlmuerzo(id:1, name: "Mollejas", selected: false),
      CheckboxAlmuerzo(id:2, name: "Champiñones", selected: false),
      CheckboxAlmuerzo(id:3, name: "Huevos de Codorniz", selected: false),
      CheckboxAlmuerzo(id:4, name: "Maiz desgranado", selected: false),
      CheckboxAlmuerzo(id:5, name: "Ensalada de la casa", selected: false),
      CheckboxAlmuerzo(id:6, name: "Jugo natural", selected: false),
      CheckboxAlmuerzo(id:7, name: "Gaseosa CocaCola", selected: false),
    });
    super.initState();
  }
                  ...
                  child: Row(
                      children: [
                        Expanded(
                          child: Column(
                              children: [
                                Image.asset('assets/Almuerzo5.jpg',width: 600,), //agregar imagen
                                ListView.builder(
                                    shrinkWrap: true,
